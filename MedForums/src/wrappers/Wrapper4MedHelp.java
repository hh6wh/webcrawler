...
public class Wrapper4MedHelp extends WrapperBase {
	...
	@Override
	protected boolean parseHTMLwithpage1(Document doc) {
	...
	protected boolean parseHTMLwithpost(Document doc) {
		//extract thread id (URL)
		Elements postElms = doc.getElementsByTag("link");
		for(Element elm:postElms) {
			if (elm.hasAttr("rel") && elm.attr("rel").equals("canonical")) {
		...
		postElms = doc.getElementsByClass("post_data");
		//special treatment of first post
		Element elm = postElms.get(0), tmpElmA;
		Post p = new Post(elm.attr("id"));
...
//		wrapper.parseHTML("hh6wh-Allergy-exhaust-fumes-page1-7.html");
//		//wrapper.parseHTML("hh6wh-Allergy-titanium-vanadium-aluminum-dental-implant-page2-9.html");
//		//wrapper.parseHTML("hh6wh-Allergy-titanium-vanadium-aluminum-dental-implant-page1-8.html");
//		
//		//wrapper.save2Json("hh6wh-Allergy-titanium-vanadium-aluminum-dental-implant-9.json");
//	}
